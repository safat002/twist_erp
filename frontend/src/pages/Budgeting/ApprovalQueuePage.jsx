...
import {
  ...
  fetchBudgetLines,
  updateBudgetLine,
  sendBackLineForReview,
  approveBudgetName,
  rejectBudgetName,
  fetchApprovalTaskDetails,
  approveApprovalLines,
  requestNameApproval,
  fetchApproval,
  approveBudgetLines,
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          ...
          <Space>
            <Button
              ...
              onClick={async () => {
                try {
                  // Use the approvals endpoint for both CC approvers and final approvers.
                  // Backend will mark per-line metadata and advance the task if applicable.
                  await approveBudgetLines(currentApprovalTask.approval_id, lineSelectedKeys);
                  message.success('Selected lines approved');
