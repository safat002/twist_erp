...
class JournalVoucherSerializer(serializers.ModelSerializer):
    ...
    total_debit = serializers.DecimalField(source="total_debit", max_digits=20, decimal_places=2, read_only=True)
    total_credit = serializers.DecimalField(source="total_credit", max_digits=20, decimal_places=2, read_only=True)
