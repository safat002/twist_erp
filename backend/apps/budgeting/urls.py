...
router.register(r'approvals', BudgetApprovalViewSet, basename='budget-approvals')
...
urlpatterns = [
    ...
    path('price-policy/', BudgetPricePolicyView.as_view(), name='budget-price-policy'),
]
