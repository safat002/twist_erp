...
urlpatterns = [
    ...
    # Provide a prefixed alias to match JS that calls /intelligent-import/...
    path('intelligent-import/', include(('intelligent_import.urls', 'intelligent_import'), namespace='intelligent_import_alias')),

    # --- Main Application Views ---
    path('report-builder/<uuid:report_id>/', report_views.report_builder_view, name='report_builder_with_id'),
