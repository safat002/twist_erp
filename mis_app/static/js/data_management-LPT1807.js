...
class DataManagementApp {
    ...
    initializeModals() {
        ...
        if (modifySchemaModalEl) this.modals.modifySchema = new bootstrap.Modal(modifySchemaModalEl);
...
bindUploadStep2Events() {
    ...
    try {
        ...
        const sheetSelect = this.getElementSafe('wizardSheetSelect');
        if (sheetSelect) {
...
sanitizeMessage(msg) {
    ...
    async handleAddColumn() {
        ...
        try {
            ...
            if (this.modals.addColumn) this.modals.addColumn.hide();
    ...
    async handleRenameColumn() {
        ...
        try {
            ...
            if (this.modals.renameColumn) this.modals.renameColumn.hide();
    ...
    async updateColumnType(columnName, newType) {
        try {
            ...
            if (this.modals.modifySchema) this.modals.modifySchema.hide();
        } catch(error) {
    ...
    setupPasswordConfirmation(title, warning, callback) {
        ...
        this.state.passwordConfirmCallback = async () => {
            ...
            try {
                ...
                if (this.modals.passwordConfirm) this.modals.passwordConfirm.hide();
            } catch (error) {
...
class ApiService {
    ...
    uploadToTable(connectionId, tableName, tempFilename, hasHeaders, replaceTable) {
        return this.fetch('/api/data/upload-data/', {
            method: 'POST',
            body: { connection_id: connectionId, table_name: tableName, temp_filename: tempFilename, has_headers: hasHeaders, replace_table: replaceTable }
        });
    }
