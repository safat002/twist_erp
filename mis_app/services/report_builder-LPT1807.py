...
class ReportBuilderService:
    ...
    def build_advanced_report(self, report_config, user, return_query_obj=False):
        ...
        try:
            ...
            connection_obj = get_object_or_404(ExternalConnection, id=connection_id, owner=user)
            ...
            all_path_tables = set(initial_table_names)
            ...
            from_obj = tables_dict[initial_table_names[0]]
            processed_tables = {initial_table_names[0]}
